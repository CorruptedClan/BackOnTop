...
-- servers
local mainserv = scriptswin:Server("Syr Scripts", "rbxassetid://13797609825")
...
loadstring(game:HttpGet("https://raw.githubusercontent.com/CorruptedClan/itemtp/main/PiggyModz.lua"))()
end)
